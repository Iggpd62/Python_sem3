...
# Щ, Э, Ю – 8 очков; Ф, Щ, Ъ – 10 очков. Напишите программу, которая вычисляет стоимость введенного пользователем слова. Будем считать, что на вход
# подается только одно слово, которое содержит либо только английские, либо только русские буквы.

# Создаем словарь со значениями букв
...
values = {
    ...
    'З': 5, 'И': 1, 'Й': 4, 'К': 2, 'Л': 2, 'М': 1, 'Н': 1, 'О': 1,
...
# Перебираем все буквы в слове и суммируем их значения
for letter in word:
    score += values.get(letter.upper(), 0)
